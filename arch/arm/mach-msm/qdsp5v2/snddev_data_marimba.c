...
static struct snddev_icodec_data snddev_iearpiece_data = {
	...
	/*20110127 frogLove - Handset Rx volume Max(9dB)/Min(-10dB) */
...
static struct snddev_icodec_data snddev_ihs_stereo_rx_data = {
	...
	.property = SIDE_TONE_MASK,
#ifdef CONFIG_MACH_MSM8X55_EF30S
	/*20101216 frogLove - Headset stereo(Bell) Rx volume max(6dB)/min(-9dB) gain */
...
#ifdef CONFIG_MACH_MSM8X55_EF30S   
	/*20101216 frogLove - Speaker stereo(Bell) Rx volume max(10dB)/min(-5dB) gain */
...
static struct snddev_icodec_data sky_vt_snddev_ispeaker_rx_data = {
	...
	/*20101216 frogLove - Speaker mono(VT) Rx volume max(10dB)/min(-5dB) gain */
	.max_voice_rx_vol[VOC_NB_INDEX] = 1000,
	.min_voice_rx_vol[VOC_NB_INDEX] = -500,
	.max_voice_rx_vol[VOC_WB_INDEX] = 1000,
	.min_voice_rx_vol[VOC_WB_INDEX] = -500,
...
static struct snddev_icodec_data sky_voice_snddev_ihs_stereo_rx_data = {
	...
	/*20110211 frogLove - Headset mono(voice) Rx volume max(10dB)/min(-9dB) gain */
	.max_voice_rx_vol[VOC_NB_INDEX] = 1000,
	.min_voice_rx_vol[VOC_NB_INDEX] = -900,
	.max_voice_rx_vol[VOC_WB_INDEX] = 1000,
	.min_voice_rx_vol[VOC_WB_INDEX] = -900
...
/* VoIP handset Rx */
static struct adie_codec_action_unit sky_voip_iearpiece_48KHz_osr256_actions[] =
	SKY_VOIP_HANDSET_RX_48000_OSR_256;

static struct adie_codec_hwsetting_entry sky_voip_iearpiece_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = sky_voip_iearpiece_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(sky_voip_iearpiece_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile sky_voip_iearpiece_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = sky_voip_iearpiece_settings,
	.setting_sz = ARRAY_SIZE(sky_voip_iearpiece_settings),
};

static struct snddev_icodec_data sky_voip_snddev_iearpiece_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "sky_voip_handset_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HANDSET_SPKR,
	.profile = &sky_voip_iearpiece_profile,
	.channel_mode = 1,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
	.pamp_on = NULL,
	.pamp_off = NULL,
	/*20110127 frogLove - VoIP Handset Rx volume Max(9dB)/Min(-10dB) */
	.max_voice_rx_vol[VOC_NB_INDEX] =  900,
	.min_voice_rx_vol[VOC_NB_INDEX] = -1000,
	.max_voice_rx_vol[VOC_WB_INDEX] =  900,
	.min_voice_rx_vol[VOC_WB_INDEX] = -1000
...
static struct platform_device sky_voip_msm_iearpiece_device = {
	.name = "snddev_icodec",
	.id = 31,
	.dev = { .platform_data = &sky_voip_snddev_iearpiece_data },
};

/* VoIP handset Tx */
static struct adie_codec_action_unit sky_voip_imic_8KHz_osr256_actions[] =
	SKY_VOIP_HANDSET_TX_8000_OSR_256;

static struct adie_codec_action_unit sky_voip_imic_16KHz_osr256_actions[] =
	SKY_VOIP_HANDSET_TX_16000_OSR_256;

static struct adie_codec_action_unit sky_voip_imic_48KHz_osr256_actions[] =
	SKY_VOIP_HANDSET_TX_48000_OSR_256;

static struct adie_codec_hwsetting_entry sky_voip_imic_settings[] = {
	{
		.freq_plan = 8000,
		.osr = 256,
		.actions = sky_voip_imic_8KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(imic_8KHz_osr256_actions),
	},
	{
		.freq_plan = 16000,
		.osr = 256,
		.actions = sky_voip_imic_16KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(imic_16KHz_osr256_actions),
	},
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = sky_voip_imic_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(imic_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile sky_voip_mic_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = sky_voip_imic_settings,
	.setting_sz = ARRAY_SIZE(sky_voip_imic_settings),
};

static enum hsed_controller sky_voip_imic_pmctl_id[] = {PM_HSED_CONTROLLER_0};

static struct snddev_icodec_data sky_voip_snddev_imic_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "sky_voip_handset_tx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HANDSET_MIC,
	.profile = &sky_voip_mic_profile,
	.channel_mode = 1,
	.pmctl_id = sky_voip_imic_pmctl_id,
	.pmctl_id_sz = ARRAY_SIZE(sky_voip_imic_pmctl_id),
	.default_sample_rate = 48000,
	.pamp_on = NULL,
	.pamp_off = NULL,
};

static struct platform_device sky_voip_msm_imic_device = {
	.name = "snddev_icodec",
	.id = 32,
	.dev = { .platform_data = &sky_voip_snddev_imic_data },
};

/* VoIP speaker Rx */
static struct adie_codec_action_unit sky_voip_ispeaker_rx_48KHz_osr256_actions[] =
   SKY_VOIP_SPEAKER_STEREO_RX_48000_OSR_256;

static struct adie_codec_hwsetting_entry sky_voip_ispeaker_rx_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = sky_voip_ispeaker_rx_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(sky_voip_ispeaker_rx_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile sky_voip_ispeaker_rx_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = sky_voip_ispeaker_rx_settings,
	.setting_sz = ARRAY_SIZE(sky_voip_ispeaker_rx_settings),
};

static struct snddev_icodec_data sky_voip_snddev_ispeaker_rx_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "sky_voip_speaker_stereo_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_SPKR_PHONE_MONO,
	.profile = &sky_voip_ispeaker_rx_profile,
	.channel_mode = 2,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
	.pamp_on = &sky_snddev_voip_speaker_pamp_on,
	.pamp_off = &sky_snddev_voip_speaker_pamp_off,
	/*20101216 frogLove - VoIP Speaker mono Rx volume max(10dB)/min(-5dB) gain */
	.max_voice_rx_vol[VOC_NB_INDEX] = 1000,
	.min_voice_rx_vol[VOC_NB_INDEX] = -500,
	.max_voice_rx_vol[VOC_WB_INDEX] = 1000,
	.min_voice_rx_vol[VOC_WB_INDEX] = -500,
...
static struct platform_device sky_voip_msm_ispeaker_rx_device = {
	.name = "snddev_icodec",
	.id = 33,
	.dev = { .platform_data = &sky_voip_snddev_ispeaker_rx_data },

};

/* VoIP speaker Tx */
static struct adie_codec_action_unit sky_voip_ispeaker_tx_8KHz_osr256_actions[] =
	SKY_VOIP_SPEAKER_TX_8000_OSR_256;

static struct adie_codec_action_unit sky_voip_ispeaker_tx_48KHz_osr256_actions[] =
	SKY_VOIP_SPEAKER_TX_48000_OSR_256;

static struct adie_codec_hwsetting_entry sky_voip_ispeaker_tx_settings[] = {
	{
		.freq_plan = 8000,
		.osr = 256,
		.actions = sky_voip_ispeaker_tx_8KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(sky_voip_ispeaker_tx_8KHz_osr256_actions),
	},
	{ /* 8KHz profile is good for 16KHz */
		.freq_plan = 16000,
		.osr = 256,
	...
	},
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = sky_voip_ispeaker_tx_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(sky_vt_ispeaker_tx_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile sky_voip_ispeaker_tx_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = sky_voip_ispeaker_tx_settings,
	.setting_sz = ARRAY_SIZE(sky_voip_ispeaker_tx_settings),
};

static enum hsed_controller sky_voip_ispk_pmctl_id[] = {PM_HSED_CONTROLLER_0};

static struct snddev_icodec_data sky_voip_snddev_ispeaker_tx_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "sky_voip_speaker_mono_tx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_SPKR_PHONE_MIC,
	.profile = &sky_voip_ispeaker_tx_profile,
	.channel_mode = 1,
	.pmctl_id = sky_voip_ispk_pmctl_id,
	.pmctl_id_sz = ARRAY_SIZE(sky_voip_ispk_pmctl_id),
	.default_sample_rate = 48000,
#ifdef CONFIG_SKY_SND_CTRL
	.pamp_on = NULL,
	.pamp_off = NULL,
...
static struct platform_device sky_voip_msm_ispeaker_tx_device = {
	.name = "snddev_icodec",
	.id = 34,
	.dev = { .platform_data = &sky_voip_snddev_ispeaker_tx_data },
};

/* VoIP Headset Rx */
static struct adie_codec_action_unit sky_voip_ihs_stereo_rx_48KHz_osr256_actions[] =
	SKY_VOIP_HEADSET_STEREO_RX_LEGACY_48000_OSR_256;

static struct adie_codec_hwsetting_entry sky_voip_ihs_stereo_rx_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = sky_voip_ihs_stereo_rx_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(sky_voip_ihs_stereo_rx_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile sky_voip_ihs_stereo_rx_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = sky_voip_ihs_stereo_rx_settings,
	.setting_sz = ARRAY_SIZE(sky_voip_ihs_stereo_rx_settings),
};

static struct snddev_icodec_data sky_voip_snddev_ihs_stereo_rx_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "sky_voip_headset_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HEADSET_SPKR_MONO,
	.profile = &sky_voip_ihs_stereo_rx_profile,
	.channel_mode = 2,
	.default_sample_rate = 48000,
	.pamp_on = &sky_snddev_voip_hsed_pamp_on,
	.pamp_off = &sky_snddev_voip_hsed_pamp_off,
	/*20110211 frogLove - VoIP Headset mono Rx volume max(-7dB)/min(-20dB) gain */
	.max_voice_rx_vol[VOC_NB_INDEX] = -700,
	.min_voice_rx_vol[VOC_NB_INDEX] = -2000,
...
static struct platform_device sky_voip_msm_ihs_stereo_rx_device = {
	.name = "snddev_icodec",
	.id = 35,
	.dev = { .platform_data = &sky_voip_snddev_ihs_stereo_rx_data },
};

/* VoIP Headset Tx */
static struct adie_codec_action_unit sky_voip_ihs_mono_tx_8KHz_osr256_actions[] =
	SKY_VOIP_HEADSET_MONO_TX_8000_OSR_256;

static struct adie_codec_action_unit sky_voip_ihs_mono_tx_16KHz_osr256_actions[] =
	SKY_VOIP_HEADSET_MONO_TX_16000_OSR_256;

static struct adie_codec_action_unit sky_voip_ihs_mono_tx_48KHz_osr256_actions[] =
	SKY_VOIP_HEADSET_MONO_TX_48000_OSR_256;

static struct adie_codec_hwsetting_entry sky_voip_ihs_mono_tx_settings[] = {
	{
		.freq_plan = 8000,
		.osr = 256,
		.actions = sky_voip_ihs_mono_tx_8KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(ihs_mono_tx_8KHz_osr256_actions),
	},
	{
		.freq_plan = 16000,
		.osr = 256,
		.actions = sky_voip_ihs_mono_tx_16KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(ihs_mono_tx_16KHz_osr256_actions),
	},
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = sky_voip_ihs_mono_tx_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(ihs_mono_tx_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile sky_voip_ihs_mono_tx_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = sky_voip_ihs_mono_tx_settings,
	.setting_sz = ARRAY_SIZE(sky_voip_ihs_mono_tx_settings),
};

static enum hsed_controller sky_voip_ihset_mic_pmctl_id[] = {PM_HSED_CONTROLLER_1};

static struct snddev_icodec_data sky_voip_snddev_ihs_mono_tx_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "sky_voip_headset_mono_tx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HEADSET_MIC,
	.profile = &sky_voip_ihs_mono_tx_profile,
	.channel_mode = 1,
#ifdef CONFIG_SKY_SND_CTRL
	.pmctl_id = sky_voip_ihset_mic_pmctl_id,
	.pmctl_id_sz = ARRAY_SIZE(sky_voip_ihset_mic_pmctl_id),
#else
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
#endif
...
static struct platform_device sky_voip_msm_ihs_mono_tx_device = {
	.name = "snddev_icodec",
	.id = 36,
	.dev = { .platform_data = &sky_voip_snddev_ihs_mono_tx_data },
};
#endif
...
static struct platform_device *snd_devices_surf[] __initdata = {
	...
	//20110126 frogLove - VoIP Rx/Tx device
	&sky_voip_msm_iearpiece_device,
	&sky_voip_msm_imic_device,
	&sky_voip_msm_ispeaker_rx_device,
	&sky_voip_msm_ispeaker_tx_device,
	&sky_voip_msm_ihs_stereo_rx_device,
	&sky_voip_msm_ihs_mono_tx_device,
#endif        	
};
