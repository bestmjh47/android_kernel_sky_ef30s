...
void snd_extamp_api_SetDevice(int on, uint32_t cad_device)
{
	...
	switch(cad_device)
	{
		...
		if (on) 
		{
	          /* 20110126 frogLove - HP PGAINA 0dB, HP(L/R) vol -12dB, HP class gain 3dB */
		...
		if (on)
		{
	          /* 20110104 frogLove - limiter off, input 3dB, output -4dB */
	          ...
	          tCurrentExtampInfo.sp_ctl_reg_val        = FFM_FF_MODE  | SPKM_UNMUTE | SPKVOL_M_4_DB;
                  //tCurrentExtampInfo.limiter_ctl_reg_val = THDCLP_BELOW_11_PER |THDT1_1_DOT_4_SEC;
		...
		if (on)
		{
	          /* 20110126 frogLove - limiter off, SP input 3dB/HP input 0dB, SP output -4dB/HP output -19dB , HP class gain 3dB */
	          tCurrentExtampInfo.inp_gain_ctl_reg_val  = INADIFF_STEREO_SINGLE | INBDIFF_DIFFERENTIAL | PGAINA_P_0_DB | PGAINB_P_3_DB;
	          tCurrentExtampInfo.hp_mixers_ctl_reg_val = HPLMIX_INA2 | HPRMIX_INA1;
	          tCurrentExtampInfo.sp_mixer_ctl_reg_val  = SPKMIX_INB2;
		...
		if (on) 
		{
	          tCurrentExtampInfo.inp_gain_ctl_reg_val  = INADIFF_STEREO_SINGLE  | INBDIFF_DIFFERENTIAL | PGAINA_P_0_DB | PGAINB_P_0_DB;
	          tCurrentExtampInfo.sp_mixer_ctl_reg_val  = SPKMIX_INB2;
	          /* 20101216 frogLove - limiter off, speaker gain 4dB */
	          tCurrentExtampInfo.sp_ctl_reg_val        = FFM_FF_MODE  | SPKM_UNMUTE | SPKVOL_P_4_DB;
	          //tCurrentExtampInfo.limiter_ctl_reg_val = THDCLP_BELOW_4_PER | THDT1_1_DOT_4_SEC;
	          tCurrentExtampInfo.power_man_ctl_reg_val = SHDN_EN  | LPMODE_DIS | SPKEN_EN | HPLEN_DIS | HPREN_DIS | BYPEN_OPEN;
		}
		else
		{
		...
		if (on)
		{
	          tCurrentExtampInfo.inp_gain_ctl_reg_val  = INADIFF_STEREO_SINGLE | INBDIFF_DIFFERENTIAL | PGAINA_P_0_DB | PGAINB_P_0_DB;
	          tCurrentExtampInfo.hp_mixers_ctl_reg_val = HPLMIX_INA2 | HPRMIX_INA1;
	          /* 20110127 frogLove - HP PGAINA 0dB, HP(L/R) vol -12dB, HP class gain 3dB */
	          tCurrentExtampInfo.hpl_ctl_reg_val       = ZCD_DIS | SLEW_DIS | HPLM_UNMUTE | HPLVOL_M_12_DB;
	          tCurrentExtampInfo.hpr_ctl_reg_val       = HPGAIN_P_3_DB | HPRM_UNMUTE | HPRVOL_M_12_DB;
	          tCurrentExtampInfo.power_man_ctl_reg_val = SHDN_EN  | LPMODE_DIS | SPKEN_DIS | HPLEN_EN | HPREN_EN | BYPEN_OPEN;
		}
		...
		if (on)
		{
	          tCurrentExtampInfo.inp_gain_ctl_reg_val  = INADIFF_STEREO_SINGLE | INBDIFF_DIFFERENTIAL | PGAINA_P_0_DB | PGAINB_P_0_DB;
	          tCurrentExtampInfo.hp_mixers_ctl_reg_val = HPLMIX_INA2 | HPRMIX_INA1;
	          /* 20110128 frogLove - HP PGAINA 0dB, HP(L/R) vol -16dB, HP class gain 3dB */
	          tCurrentExtampInfo.hpl_ctl_reg_val       = ZCD_DIS | SLEW_DIS | HPLM_UNMUTE | HPLVOL_M_16_DB;
	          tCurrentExtampInfo.hpr_ctl_reg_val       = HPGAIN_P_3_DB | HPRM_UNMUTE | HPRVOL_M_16_DB;
	          tCurrentExtampInfo.power_man_ctl_reg_val = SHDN_EN  | LPMODE_DIS | SPKEN_DIS | HPLEN_EN | HPREN_EN | BYPEN_OPEN;
		}
		else
		{
