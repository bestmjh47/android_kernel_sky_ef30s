...
void qt_Power_Config_Init(void)
{
    ...
    /* Set Active Acquisition Interval to 16 ms. */
    power_config.actvacqint = CHARGER_UNPLUGGED_ACTVACQINT;		//T7_ACTVACQINT;
...
void qt_CTE_Config_Init(void)
{
    ...
    cte_config.idlegcafdepth = CHARGER_UNPLUGGED_IDLEGCAFDEPTH;	//T28_IDLEGCAFDEPTH;
    cte_config.actvgcafdepth = CHARGER_UNPLUGGED_ACTVGCAFDEPTH;
    if(tsp_version >= 0x15)
    {
